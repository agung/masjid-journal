    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b bg-white shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-900 leading-tight">Preview Laporan</p>
      ...
      {/* Mobile fallback */}
      <div className="sm:hidden bg-amber-50 border-t border-amber-200 px-4 py-2.5 shrink-0">
